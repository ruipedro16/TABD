...
\begin{document}
    ...
    Some modifications were made in the original script.
    This was mainly motivated due to the fact that same athletes and clubs had different \texttt{ids} for different meets,
    when in our perspective they should be uniquely identified across tournaments.
    ...
    To do this, we would only have to pre-process the data to ensure it conforms to the database schema. % Rever esta frase
